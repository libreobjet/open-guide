...
Designers as well could explore these practices by for example offering customizations of an open source model.
...
The relation here can then be based on longer mutual support, more precise understanding of needs and an improved quality of life by respecting the different partners involved. Cutting the middleman could also be profitable for both.
...
Opendesk promises to be a hub between designers and local builders. Their pusiness is built on creating, collecting and promoting open designs (not all open source) and encouraging the local production of it through a network of fablabs and makerspaces. They then take a small portion of the price charged to the end user.

### Snowdrift 
These type of plateforms encourage participants to provide regular donations to the projects they want to support. Through very small recuring payments and social network effects, creator could potentialy harvest a montly salary allowing them the pursuit of their cerative work.  https://snowdrift.coop/
...
With  _X-Modules_, Maria Solé Bravo and Julien Deswaef have developped a multi-purpose design to furnish the courtyard at the entrance of the Ixelles public library, in Brussels. As required by the library, the furniture is made from upcycled material: re-used pallets and was built by the neighbors and school children during a series of workshops. The open source nature of the it fitted perfectly with the mission of the library and was one of the key factors that got this project selected after the competition.
