...
Un diseñador es un creador, un artista que se inspira en un origen divino. Se autoriza la citación de los maestros, pero siempre debe venir con algo nuevo y original.

#### Diseñar localmente, fabricar muy lejos.
Los diseñadores famosos trabajan como grandes marcas, donde sus productos se fabrican al otro lado del planeta para limitar los costos y mantener los precios bajos para el mercado final, mientras que dan un margen cómodo para los productores.
...
Con el diseño de productos de código abierto, estamos trasladando todo el proceso de diseño de nuevo a la fuente: cuidar de los seres humanos, cada ser humano.

Buscamos una actitud generosa y creativa en la que sabemos que una obra de arte se inspira en la naturaleza y debe respetarla.

Nos permitimos copiar como forma de aprender, fomentar nuestra creatividad e iterar los procesos de diseño.

![_Guy_ − Mathieu Gabiot − Free Art License](./images/guy-bulle.svg)

Aprendemos de las tradiciones y diseños existentes, y no intentamos reinventar la rueda cada vez.

No enfocamos nuestros diseños en los beneficios pero los vemos como un servicio para la sociedad.

Nosotros elegimos el camino libre/libre porque podemos confiar en una comunidad para ayuda, co-trabajo y remezclas.

No tenemos miedo de ser copiados.

![](./images/girl-bulle.svg)

Queremos una relación cercana con nuestros usuarios, convertirlos en contribuyentes activos y obtener retroalimentación objetiva.

Queremos desafiar el status quo y romper las barreras sociales.

Pensamos en el diseño de productos como un proceso, como comunicación, como información, y quiere ser libre.

Sabemos que las licencias de código abierto son una clave en el upcycling y un marco legal para el pensamiento cradle to cradle.

![](./images/guy-bulle.svg)

No tenemos una sola talla para todos, así que aquí están nuestros archivos para que se adapten a ti.

Si no puedes modificarlo, repararlo o mejorarlo, no te pertenece y esto nos enfurece.

No estamos buscando la perfección, pero sabemos que tenemos más posibilidades de alcanzarla si trabajamos juntos.

### Diseño conjunto

Optar por una licencia libre garantiza el respeto al autor y la protección de sus derechos como autor, al tiempo que asegura la visibilidad y difusión.

El uso de licencias libres cambia también los modos de producción, concepción y fabricación de un objeto. El trabajo del diseñador requiere muchas habilidades y experiencia. Así que un solo objeto puede tardar años en desarrollarse, requiriendo múltiples habilidades. A menudo, varias personas contribuyen al diseño de un objeto. La publicación de un objeto utilizando licencias libres abre la posibilidad de trabajar con otros, locales o remotos, utilizando varios ciclos consecutivos de modificación de publicación.

Los consumidores pueden apropiarse del objeto y hacer un uso diferente del mismo o adaptarlo a sus propias necesidades. Aunque este escenario podría ser deseable para todo, no es cierto hoy en día. Normalmente los objetos tienen una etiqueta que dice algo así: "" _La garantía se anula si es manipulada por el usuario o hecha un uso inapropiado de ella_ ". En el peor de los casos, también puede haber retroceso legal.

Con el diseño de producto de código abierto, reclamamos la propiedad total que un comprador tiene sobre lo que ha adquirido.

###  Ecodiseño
> El ecodiseño es un enfoque para el diseño de productos con especial atención a los impactos ambientales del producto durante todo su ciclo de vida. En una evaluación del ciclo de vida, el ciclo de vida de un producto suele dividirse en adquisición, fabricación, uso y eliminación.  
−[Wikipedia](https://en.wikipedia.org/wiki/Ecodesign )

En este sentido, el aspecto ambiental es una parte importante del proyecto, ya sea el entorno natural o social en juego. Y el diseño de productos de código abierto podría jugar un papel importante en estas prácticas.


- Adquisición: la mayoría de los proyectos de diseño de código abierto podrían o deberían utilizar materiales locales.
- Fabricación: el producto puede ser construido bajo demanda, localmente, respetando las leyes laborales.
- Eliminación: Permitir que las personas modifiquen los diseños podría favorecer la adaptación, la reutilización y la reducción de residuos.

Cuando una persona elige un producto de código abierto, se aleja de una posición de consumidor pasivo y pasa a un proceso de colaboración que podría ser potencialmente un sistema menos contaminante que el consumo productivo.

Herramientas
-----
Ok, este es un asunto complicado. ¿Cuáles son las herramientas para mantenerse motivado o motivarse para entrar en el diseño de productos de código abierto? En realidad es una pregunta muy personal. Esperamos que este libro sea una herramienta. Dínoslo tú. Pero aquí hay otras sugerencias.

### Inspírate
Lee, busca y documentate. Esta es la razón por la que hemos puesto una parte de "comida para Pensar" en cada sección del libro. Porque las cosas enumeradas aquí, de una forma u otra, nos inspiraron y motivaron.  
...
### Conéctate
Esta es una comunidad. Estamos en línea y fuera de línea hablando entre nosotros, apoyándonos mutuamente.  

Objetos
-----------
### Estetoscopio de código abierto de Tarek Loubani
